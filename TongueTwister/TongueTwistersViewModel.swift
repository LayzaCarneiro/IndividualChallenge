...
class TongueTwisterViewModel: ObservableObject {
    ...
    @Published var tongueTwisters: [TongueTwisterModel] = [
        ...
        TongueTwisterModel(title: "Rugged Rocks", text: "Round and round the rugged rocks, the restless river rushes, roaring rapidly as red robins race to rest in the rustling reeds.", phonemes: ["/ r /", "/ s /"], icon: "water.waves"),
        ...
        TongueTwisterModel(title: "Grandma’s Garden", text: "Great green grapes grow in Grandma’s garden, glistening under the golden glow of the gentle morning sun.", phonemes: ["/ g /"], icon: "leaf.fill"),
