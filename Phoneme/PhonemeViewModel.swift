...
class PhonemeViewModel: ObservableObject {
    @Published var phonemes: [Phoneme] = [
        ...
        ], words: ["shop", "dash", "issue", "sugar", "motion", "pushed"], soundFile: "sh"),
        ...
        ], words: ["sample", "stocks", "past", "race", "slip", "strong"], soundFile: "s"),
        ...
        ], words: ["thanks", "thought", "bath", "fifth", "nothing"], soundFile: "th"),
        ...
        ], words: ["close", "business", "please", "exactly"], soundFile: "s")
    ]
